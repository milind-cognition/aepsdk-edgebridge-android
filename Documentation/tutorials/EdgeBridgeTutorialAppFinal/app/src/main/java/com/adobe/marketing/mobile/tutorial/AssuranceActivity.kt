...
class AssuranceActivity : AppCompatActivity() {
    ...
    private lateinit var btnConnectToAssuranceSession: Button
    private lateinit var txtAssuranceSessionURL: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnConnectToAssuranceSession.setOnClickListener {
            Assurance.startSession(txtAssuranceSessionURL.text.toString())
        }
    }
}

 ...
 * - Enables forwarding of [MobileCore.trackState] and [MobileCore.trackAction] calls to the
 *   Adobe Edge Network. The configured Data Collection datastream for the mobile application can
 *   define a mapping of the track event's `contextdata` to an XDM schema using Data Prep for
 *   Data Collection.
 */
object EdgeBridge {
